...
import {View, Text, Alert, StyleSheet,TouchableNativeFeedback, Image,ImageBackground} from 'react-native';
...
// const CustomSidebarMenu = (props) => {
  ...
  return (
    ...
    <View style={stylesSidebar.sideMenuContainer}>
      ...
      <DrawerContentScrollView {...props} style={{backgroundColor:'white',color:'black'}}>
