...
import {
  ...
  FlatList,
  ActivityIndicator,
  Pressable,StyleSheet,Button,Image
} from "react-native";
...
export default class Details extends Component {
  ...
  render() {
    ...
    <ListItem.Content>
      <ListItem.Title style={{ color: 'black', fontWeight: 'bold' }}>{`${item.activityType}`}</ListItem.Title>
