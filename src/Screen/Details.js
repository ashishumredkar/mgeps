...
export default class Details extends Component {
  ...
  render() {
    return (
      ...
      <CustomToolbar navigation={this.props.navigation} title={this.state.pageTitle} userType ={"Merchant"} backgroundColor="#3775f0"/>
                ...
                >
                  <View style={{ flexDirection: "column", margin: 10 }}>
                    <View style={{ flexDirection: "row" }}>
                      <Text style={[{ color: "blue", fontSize: 18, flex: 1 }]}>
